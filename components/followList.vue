	...
	<view class="followList">
		<scroll-view style="height: 100%;" scroll-y="true" @scroll="scroll">
			<view class="item" v-for="(item,index) in list" :key="item.id">
				<view class="top">
					<view class="img-box">
						<image class="img" src="../static/img/1-1.jpeg"></image>
					</view>
				...
				<view class="box">
					...
					<view class="right">
						<view class="iconfont icon-heart-fill icon">
							<text class="text">赞</text>
						</view>
						<view class="iconfont icon-tubiaozhizuo- icon">
							<text class="text">评论</text>
						</view>
						<view class="iconfont icon-zhuanfa icon">
				...
				<view class="comment">
					...
					<view class="comment-box">
						<view class="iconfont icon-bianji icon-pen">
						</view>
