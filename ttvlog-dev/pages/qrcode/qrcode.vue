	...
	<view class="page">
		...
		<view class="qrcode-box" style="width: 550rpx;height: 700rpx;margin-top: 320rpx;align-self: center;">
			...
			<view class="user-box">
				...
				<text style="align-self: center; margin-top: 10rpx;font-size: 14px;font-weight: 400;">推推Vlog</text>
				...
				<text style="align-self: center; margin-top: 20rpx;color: #808080;font-size: 11px;font-weight: 300;">请扫描二维码</text>
			</view>
